...
from .views import JobListView, JobDetailsView
from .views import JobTemplateListView, JobTemplateDetailsView
from .views import JobParameterListView, JobParameterDetailsView
from .views import JobLogEntryListView, JobLogEntryDetailsView
